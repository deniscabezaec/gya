...
class businessup_service_widget extends WP_Widget {    
	...
	?>
                ...
                <label for="<?php echo $this->get_field_id( 'fa_icon' ); ?>"><?php _e( 'Enter font awesome icon class (like: fa-cloud','businessup'); ?> <a href="https://fontawesome.com/v4.7.0/icons/" target="blank" > <?php _e('Here all icon','businessup');?> </a></label> 
