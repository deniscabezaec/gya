...
TreasureHunter.PlayLevel.prototype = {
    ...
    update: function () {
        ...
        if (this.input.keyboard.isDown(Phaser.Keyboard.M)) {//More - Al precionar tecla M incrementa la velocidad del juego
            this.playerVelocity += 5;
        }else{
            if (this.input.keyboard.isDown(Phaser.Keyboard.L)) {//Less - Al precionar tecla L incrementa la velocidad del juego
                this.playerVelocity -= 5;
            }
        }

        if (this.input.keyboard.isDown(Phaser.Keyboard.I)) {//More - Al precionar tecla M incrementa la velocidad del juego

            if (this.inmortalidad == false) {//Less - Al precionar tecla L incrementa la velocidad del juego
